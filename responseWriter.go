...
// copy of negroni response writer
...
type ResponseWriter interface {
	...
	// Saves the err before calling WriteHeader(s)
	WriteHeaderError(s int, err error)
...
func (rw *responseWriter) WriteHeaderError(s int, err error) {
	rw.err = err
	rw.WriteHeader(s)
}
